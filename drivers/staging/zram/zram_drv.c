...
static int __init zram_init(void)
{
	...
	if (!zram_num_devices) {
		...
		zram_num_devices = 1; // Yank555.lu : Default to 4 for those wanting to use up to 4 concurrent zram swap devices
	}
